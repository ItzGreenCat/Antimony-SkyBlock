...
public class KeyLoader {
    ...
    public static KeyBinding SwitchHUDState;
    ...
    public KeyLoader()
    {
        ...
        KeyLoader.SwitchHUDState = new KeyBinding("切换HUD开关状态", Keyboard.KEY_RSHIFT, "Antimony-SkyBlock");
        ...
        ClientRegistry.registerKeyBinding(KeyLoader.SwitchHUDState);
