...
public class ItemTranslate {
    ...
    public ItemTranslate(){
        ...
        HighLevelMapping.put("The Art of War","孙子兵法");
        HighLevelMapping.put("New Year Cake","新年蛋糕");
        ...
        normalMapping.put("Shiny","闪亮的");
        normalMapping.put("Florid","华丽的");
        normalMapping.put("Chest","箱子");
        normalMapping.put("Bait","鱼饵");
        normalMapping.put("Music","音乐");
        normalMapping.put("Menu","菜单");
        normalMapping.put("Dye","染料");
        normalMapping.put("Handle","手柄");
        normalMapping.put("Alloy","合金");
        normalMapping.put("Dark","黑暗的");
        normalMapping.put("Scroll","卷轴");
        normalMapping.put("Drill","钻头");
        normalMapping.put("Guardian","守卫者");
        normalMapping.put("Bag","包");
        normalMapping.put("Recipe","配方");
        normalMapping.put("Pets","宠物");
        normalMapping.put("Bank","银行");
        normalMapping.put("Quiver","箭袋");
        normalMapping.put("Your","你的");
        normalMapping.put("Travel","旅行");
        normalMapping.put("Essence","精粹");
        normalMapping.put("Clownfish","小丑鱼");
        normalMapping.put("Pufferfish","河豚");
        normalMapping.put("Pearl","珍珠");
        normalMapping.put("Sand","沙子");
        normalMapping.put("Netherrack","下界岩");
    }
