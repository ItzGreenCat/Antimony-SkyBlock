...
public class TitleManager {
    ...
    public TitleManager(){
        ...
        TipsList.add("你知道吗?Aspect of the End只比Aspect of the Void少消耗五点mana");
        ...
        TipsList.add("Slime Minion是当前性价比最高的Minion");
    ...
    public void ClientTickEvent(TickEvent.ClientTickEvent event){
        if(tick == MaxTick) {
            tick = 0;
            Display.setTitle("Antimony " + Antimony.VERSION + " | " + TipsList.get(new Random().nextInt(TipsList.size())) + " (Minecraft 1.8.9)");
        } else {
            tick = tick + 1;
        }
    }
