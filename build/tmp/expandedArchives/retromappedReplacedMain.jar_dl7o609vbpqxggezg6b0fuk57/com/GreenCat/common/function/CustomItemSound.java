...
public class CustomItemSound {
    ...
    public void SoundTrigger(PlayerInteractEvent event) throws FileNotFoundException {
        File CustomSoundDirectory = new File(Antimony.GreenCatAddonDirectory,"CustomSound");
                        ...
                        for (String content : contentList) {
                            ...
                            try {
                                if (K4V[0].equals("name")) {
                                    if (EnumChatFormatting.func_110646_a(StringUtils.func_76338_a(Minecraft.func_71410_x().field_71439_g.field_71071_by.func_70301_a(Minecraft.func_71410_x().field_71439_g.field_71071_by.field_70461_c).func_82833_r())).contains(K4V[1])) {
