...
public class GolemESP {
    ...
    public void RenderLavaESP(RenderWorldLastEvent event) {
        if (FunctionManager.getStatus("GolemESP")) {
            ...
            List<EntityGolem> entityList = Minecraft.func_71410_x().field_71441_e.func_175647_a(EntityGolem.class, new AxisAlignedBB(x - (500 / 2d), y - (256 / 2d), z - (500 / 2d), x + (500 / 2d), y + (256 / 2d), z + (500 / 2d)), null);
            for(Entity entity : entityList){
                Utils.OutlinedBoxWithESP(entity.func_174813_aQ(),new Color(255,0,0),false);
            }
        }
    }
}
