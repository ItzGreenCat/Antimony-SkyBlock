    ...
    public void func_71515_b(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args.length == 1) {
            ...
            if(args[0].equals("sw")) {
                ...
                utils.print(String.valueOf(scaledResolution.func_78326_a()));
            }
            ...
            if(args[0].equalsIgnoreCase("AutoFishPresentYaw")) {
                Antimony.AutoFishYaw = (int) Minecraft.func_71410_x().field_71439_g.field_70177_z;
                utils.print("Yaw已设置为" + Minecraft.func_71410_x().field_71439_g.field_70177_z);
            }
